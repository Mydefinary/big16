...
const OperatorDashboard = ({ userInfo }) => {
  ...
  return (
    <div className="dashboard-main-container">
      {/* 운영자 웰컴 섹션 */}
      <div className="operator-welcome-section">
        <div className="operator-welcome-content">
          <div className="operator-welcome-icon">⚙️</div>
          <h1 className="operator-welcome-title">운영자 대시보드</h1>
          <p className="operator-welcome-message">
            <span className="username">
              {showFullInfo ? userInfo.nickName : maskName(userInfo.nickName)}
            </span> 운영자님, ToonConnect 운영 관리 시스템에 오신 것을 환영합니다!
          </p>
          <div className="operator-badge">
            <span className="badge-icon">🔧</span>
            <span className="badge-text">Operator</span>
          </div>
        </div>
      </div>
      ...
      <div className="services-section">
        ...
        <p className="services-subtitle">운영자 권한으로 모든 서비스를 이용할 수 있습니다</p>
      ...
      {/* 운영자 빠른 액션 */}
      <div className="operator-quick-actions-section">
        <h3 className="operator-quick-actions-title">⚡ 빠른 액션</h3>
        <div className="operator-quick-actions-grid">
          <button 
            className="operator-quick-action-btn mypage"
          ...
          <button 
            className="operator-quick-action-btn faq"
          ...
          <button 
            className="operator-quick-action-btn privacy"
          ...
          <button 
            className="operator-quick-action-btn logout"
      ...
      <div className="operator-info-section">
        ...
        <div className="operator-info-grid">
          <div className="info-item">
            <span className="info-label">운영자 ID</span>
          ...
          <div className="info-item">
            ...
            <span className="info-value">운영자</span>
          </div>
          <div className="info-item">
